...
import com.football.net.http.reponse.impl.JudgeRecuitBeanResult;
 ...
 */
public class PlayerDetial4CaptainActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_4_captain_detail);
    ...
    //GET http://120.24.89.9/app/activeRecruit?playerId=94&teamId=31 HTTP/1.1
    public void judgeRecruit(final String id) {
        ...
        //3.请求数据
        new SmartClient(this).get(HttpUrlConstant.APP_SERVER_URL + "activeRecruit", params, new SmartCallback<JudgeRecuitBeanResult>() {

            @Override
            public void onSuccess(int statusCode, JudgeRecuitBeanResult result) {
        ...
        }, JudgeRecuitBeanResult.class);
    }

    public void recruit(final String id) {
        if (FootBallApplication.userbean.getTeam() == null) {
            return;
        }
        showProgress("提交中...");
        ...
        params.put("teamId", FootBallApplication.userbean.getTeam().getId());
        //3.请求数据
        new SmartClient(this).get(HttpUrlConstant.APP_SERVER_URL + "recruitPlayer", params, new SmartCallback<Result>() {
    ...
    @OnClick({R.id.layout1, R.id.layout2, R.id.layout3, R.id.layout6, R.id.recuit, R.id.layout4})
    void onClick(View v) {
