 ...
 */
public class FootballTeamAdapter extends UltimateViewAdapter<FootballTeamAdapter.ScoreMemberAdapterViewHolder> {

    private ArrayList<TeamBean> data;
    private OnItemClickLitener mOnItemClickLitener;

    public FootballTeamAdapter(ArrayList<TeamBean> msgList) {
        this.data = msgList;
    }
