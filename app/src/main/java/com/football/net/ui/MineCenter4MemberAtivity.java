...
@EActivity(R.layout.activity_mine_center4member)
public class MineCenter4MemberAtivity extends BaseActivity {
    ...
    @Click({R.id.imageMyinfo, R.id.layout1, R.id.layout2, R.id.layout3, R.id.layout4, R.id.layout5, R.id.layout8})
    void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.layout2: {
                Intent intent1 = new Intent(this, MineJoinedExerciseActivity.class);
                this.startActivity(intent1);
                break;
            }
            case R.id.layout3: {
