...
public class PackageUtils {
	...
	public static PackageInfo getPackageInfo(Context context) {
		...
		// 根据packageName获取packageInfo
		try {
			info = manager.getPackageInfo(context.getPackageName(), PackageManager.GET_UNINSTALLED_PACKAGES);
		} catch (PackageManager.NameNotFoundException e) {
			LogUtils.e(e);
		}
		return info;
    ...
    public static boolean checkApkExist(String packageName) {
        try {
            ...
            pm.getApplicationInfo(packageName, PackageManager.GET_SIGNATURES);
            return true;
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            return false;
