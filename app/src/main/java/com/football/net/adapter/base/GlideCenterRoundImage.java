 ...
 */
public class GlideCenterRoundImage extends BitmapTransformation {

    private static float radius = 0f;

    public GlideCenterRoundImage(Context context) {
        this(context, 4);
    }

    public GlideCenterRoundImage(Context context, int dp) {
        super(context);
